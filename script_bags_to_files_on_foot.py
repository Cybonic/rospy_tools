...
def get_static_tf(bag_files,static_tf, file = 'static_tf.txt', topic = '/tf_static', verbose = False):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--target_bag_dir",default='/media/tiago/vbig/dataset/GEOGIATECH-FR/on-foot/rosbags/210115')
    parser.add_argument("--pcl_topic",default='/rslidar_points') # extracts from sensor_msgs/PointCloud2
    parser.add_argument("--pose_topic",default='/vectornav/GPS_INS') # extracts from sensor_msgs/NavSatFix
    parser.add_argument("--dst_root",default='/media/tiago/vbig/dataset/GEOGIATECH-FR/on-foot/rosbags/210115')
    parser.add_argument("--multibag",default=False,type=bool)
    ...
    #get_static_tf(bags,static_tf=static_tf,file=file,topic = '/tf',verbose=True)
    ...
    info_fd.write("tf -> transformation matrix 3x4 a11,a12,a13,a21,a22,a23,a31,a32,a33 you need to add the last row [0,0,0,1]\n")
